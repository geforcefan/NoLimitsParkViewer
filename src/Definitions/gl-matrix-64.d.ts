// Type definitions for gl-matrix 2.2.2
    ...
    declare class vec2 extends Float64Array {
         ...
         * @returns a
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec2 | number[], b: vec2 | number[], arg: any) => void, arg: any): Float64Array;
         ...
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec2 | number[], b: vec2 | number[]) => void): Float64Array;
...
// vec3
    declare class vec3 extends Float64Array {
         ...
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec3 | number[], b: vec3 | number[], arg: any) => void, arg: any): Float64Array;
         ...
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec3 | number[], b: vec3 | number[]) => void): Float64Array;
...
// vec4
    declare class vec4 extends Float64Array {
         ...
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec4 | number[], b: vec4 | number[], arg: any) => void, arg: any): Float64Array;
         ...
         */
        public static forEach(a: Float64Array, stride: number, offset: number, count: number,
                              fn: (a: vec4 | number[], b: vec4 | number[]) => void): Float64Array;
